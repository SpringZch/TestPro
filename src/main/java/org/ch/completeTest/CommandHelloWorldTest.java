...
public class CommandHelloWorldTest {
    ...
    */
    @Test
    public void testynchronous()throws ExecutionException, InterruptedException{
        Future<String> fWord = new CommandHelloWorld("world").queue();
        System.out.println(fWord.get()); //异步执行用get来获取结果
    }
    /**
